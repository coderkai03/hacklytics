...
MODEL_PATH = os.path.join(os.path.dirname(__file__), 'models/stacking_view_predictor.pkl')
    ...
    try:
        ...
        feature_vector = np.array([[
            features[col] for col in [
                ...
                'noise_floor', 'face_to_duration_ratio', 'text_density',
                'screen_recording_density', 'audio_quality_score', 'audio_dynamics_score',
                'audio_clarity_score', 'face_text_ratio', 'content_density',
                'engagement_score'
            ]
        ]])
